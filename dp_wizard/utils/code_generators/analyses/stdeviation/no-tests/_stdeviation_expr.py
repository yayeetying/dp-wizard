...
float_dom = atom_domain(T=float, nan=True, bounds=(LOWER_BOUND, UPPER_BOUND))
...
lap_mech = make_laplace(
    bounded_variance.output_domain, bounded_variance.output_metric, scale=10 / 1
)
